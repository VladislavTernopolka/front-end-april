...
<div class="about-head">
    ...
    function createNewPage() {
        var template = `
        <div class="NewPage">
        <h2>What are you want add?</h2>
        <h3>Please,write your desire!</h3>
        <form>
            <input id="textArea1" type="text"/>
            <input id="textArea2" type="text"/>
            <input id="textArea3" type="text"/>
            <button id="sendSubmit">Submit</button>
        </form>
        `;
        return template;
    }
    ...
    function renderNewPage() {
        var aboutHolder = document.createElement('div');
        aboutHolder.id = 'npage';

        VIEW.appendChild(aboutHolder);

        aboutHolder.innerHTML = createNewPage();
        document.getElementById('sendSubmit', 'textArea1', 'textArea2', 'textArea3', 'textArea4').addEventListener('click', sendForm);
    ...
    function sendForm(event) {
        ...
        var frm = {
            title = document.getElementById('textArea1'),
            text = document.getElementById('textArea2'),
            img = document.getElementById('textArea3');
        }
